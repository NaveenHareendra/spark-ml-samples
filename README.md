# Sample Application for "Music Genre Identifier Sample"
 
## Thanks to the efforts of @Taras Matyashovsky

This is now a sample application that  has the ability to predict 7 music genres with 80 percent accuracy on unseen data.
...
Strategy:
* Collect raw data set of verse1 (28,000 sentences in total):
